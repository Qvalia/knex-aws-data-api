...
describe('utils', () => {
  describe('parseTimestamp', () => {
    ...
    it('should parse max js date', () => {
      ...
      expect(result instanceof Date);
      expect(result.toISOString()).toBe('+275760-09-13T00:00:00.000Z');
    });
    ...
    it('should parse min js date', () => {
      ...
      expect(result instanceof Date);
      expect(result.toISOString()).toBe('-271821-04-20T00:00:00.000Z');
    });
